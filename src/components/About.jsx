        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="about-description text-[#AAADB0] mb-8 leading-relaxed">
              GR CAR LAB combines advanced techniques, bio-friendly products and
              experienced technicians to deliver reliable, high-quality
              automotive care, with a clear focus on improving aesthetics,
              longevity and customer confidence while treating every car as our
              own.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            {stats.map((stat, idx) => (
              <div key={idx} className="text-center hover-scale">
                <div
                  className="text-4xl md:text-5xl font-bold text-[#D4D414] mb-2 stat-number"
